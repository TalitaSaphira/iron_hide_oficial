...
{ 
	...
	/* 
        ...
        We are going to use only North, South, East and West to solve our problem
        */
...
//	return 0;
//}
// //Digite ctrl+atl+n para executar o código, com o code runner instalado